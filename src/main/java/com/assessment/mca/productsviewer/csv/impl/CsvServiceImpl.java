...
public class CsvServiceImpl implements CsvService {
    ...
    @Override
    public List<Product> readProductsFromCSV(File file) throws IOException {
    ...
    @Override
    public List<Sizes> readSizesFromCSV(File file) throws IOException {
    ...
    @Override
    public List<Stock> readStocksFromCSV(File file) throws IOException {
